...
class DialogsPlayer extends StatefulWidget {
  var id_tournament, players;

  DialogsPlayer({this.id_tournament, this.players});

  @override
  _DialogsPlayerState createState() => _DialogsPlayerState();
}

class _DialogsPlayerState extends State<DialogsPlayer> {
  ...
  showMember(id) async {
    ...
    final response = await client.get(
        "$request/api/tournaments/${id}/reserves?page=${pageNumber}",
        headers: {
